      ...
      >
        <HStack spacing={3}>
          ...
          <VStack align="start" spacing={1} flex={1} minW={0}>
            <Text fontSize="sm" fontWeight="medium" color={textColor} isTruncated maxW="220px" title={file.fileName}>
              {file.fileName}
            </Text>
            <HStack spacing={2}>
    ...
    >
      <VStack align="start" spacing={3}>
        ...
        {message.pdfFile && (
          ...
          >
            <HStack spacing={3}>
              <Text fontSize="xs" color={useColorModeValue('red.600', 'red.300')} fontWeight="bold">PDF</Text>
              <Text fontSize="sm" flex={1} color={textColor} isTruncated>{message.pdfFile.fileName}</Text>
              <Link href={message.pdfFile.fileUrl} download={message.pdfFile.fileName} isExternal>
                <Icon
                  as={FaDownload}
                  boxSize={4}
                  color={useColorModeValue('red.500', 'red.300')}
                  _hover={{ color: useColorModeValue('red.600', 'red.200') }}
                />
              </Link>
            </HStack>
          </Box>
