...
export function HeroSection() {
  ...
  return (
    <div className="relative pt-20 pb-12 sm:pt-24 sm:pb-16 md:pt-32 md:pb-24 overflow-hidden w-full">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-4 sm:space-y-6">
          ...
          <motion.h1
            ...
            className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight sm:leading-[1.1] flex flex-row flex-wrap items-baseline justify-center gap-x-2 gap-y-1 sm:gap-3 -mt-2 sm:-mt-8"
          >
            <span className="text-gradient-hero inline-block leading-none whitespace-nowrap">AI-Powered</span>
            <span className="inline-flex items-center flex-shrink-0"><AnimatedGavel /></span>
            <span className="inline-block text-center sm:text-left flex-shrink-0 leading-none">
              <TypewriterText
          ...
          <div className="bg-judicial-navy/30 backdrop-blur-sm border border-judicial-gold/20 rounded-2xl p-6 sm:p-8 md:p-12 max-w-4xl mx-auto">
            ...
            {/* <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-judicial-gold text-judicial-gold hover:bg-judicial-gold/10 transition-transform duration-300 hover:scale-105 w-full sm:w-auto">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-gray-400 dark:text-gray-300 mb-4">
                ...
                <div className="mb-4">
                  <span className="px-3 py-1 rounded bg-judicial-gold text-judicial-dark font-semibold text-sm">It's Free!</span>
                </div>
                <Link to="/chat" className="inline-block px-6 py-3 rounded-lg bg-judicial-gold text-judicial-dark font-semibold hover:bg-judicial-lightGold transition-colors text-base">
                  Start Chatting
                </Link>
          </div>
        </div>
