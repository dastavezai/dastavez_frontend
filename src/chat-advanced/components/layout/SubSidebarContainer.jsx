...
const SubSidebarContainer = () => {
  const { activeTab, borderColor, handleStartNewChat, isEditMode, isPrecedencePanelOpen, isCounterMakerPanelOpen } = useAdvancedChat();
  ...
  if (activeTab === 'closed' || isEditMode || isPrecedencePanelOpen || isCounterMakerPanelOpen) return null;
