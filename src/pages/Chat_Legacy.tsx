    ...
    <div className="min-h-screen bg-white dark:bg-judicial-dark transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg mb-4 px-4 sm:px-0">
                ...
                {messages.length === 0 ? (
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {messages.map((message, index) => (
                      ...
                      >
                        <div
                          className={`max-w-[85%] sm:max-w-[80%] md:max-w-[75%] lg:max-w-[70%] rounded-2xl p-3 sm:p-4 md:p-5 shadow-lg ${message.role === 'user'
                        ...
                        >
                          <div className="flex items-start gap-3 sm:gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className={`text-xs mt-3 sm:mt-4 ${message.role === 'user' ? 'text-judicial-dark/60' : 'text-gray-600 dark:text-gray-400'
                                }`}>
