    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <Suspense fallback={
              <div className="min-h-screen bg-white dark:bg-judicial-dark flex items-center justify-center">
                <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-judicial-gold"></div>
              </div>
            }>
              <UseCases />
            </Suspense>
